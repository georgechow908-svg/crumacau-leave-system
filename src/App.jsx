        ...
        <div className="fixed inset-0 bg-slate-900/40 flex items-center justify-center z-50 p-4 animate-fade-in" onClick={() => setSelectedLeave(null)}>
          <div className="bg-white rounded-xl p-6 max-w-sm w-full shadow-xl" onClick={e => e.stopPropagation()}>
            ...
            <div className="space-y-3 text-sm text-slate-600">
              ...
              <p><span className="font-medium text-slate-500">請假類別：</span>
              ...
              <p><span className="font-medium text-slate-500">請假期間：</span>{selectedLeave.startDate} ~ {selectedLeave.endDate}</p>
              <div className="pt-2">
                <span className="font-medium text-slate-500 block mb-1">原因 / 備註：</span>
